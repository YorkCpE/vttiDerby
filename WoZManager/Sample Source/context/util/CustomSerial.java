package edu.vt.ece.context.util;
...
/*
 * Modified to remove reference to PApplet. Should work with any objec that implements SerialEvent
 * JBF 5/12/12
 */
 ...
 * @usage application
 */
public class CustomSerial implements SerialPortEventListener {
 ...
 */
  public CustomSerial(Object parent) {
 ...
 */
  public CustomSerial(Object parent, int irate) {
 ...
 */
  public CustomSerial(Object parent, String iname, int irate) {
    this(parent, iname, irate, dparity, ddatabits, dstopbits);
  }

  public CustomSerial(Object parent, String iname) {
